...
class PddlStruct:
    ...
    def add_object(self, group_name: str, identifier: str) -> None:
        """
        ...
        self.object[group_name].append(identifier)

    def add_object_group(self, group_name: str) -> None:
        """
        :param group_name: name of object's group
        :return: None
        """
    ...
    def __or__(self, other):
        ...
        :return: new PddlStruct (or raises error, if other is not PddlStruct)
        """
